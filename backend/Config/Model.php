  ...
  try {
    switch ($this->db_type) {
        ...
        case "pgsql":
            ...
            break;
        case "sqlite":
            $dsn = "sqlite:" .  "C:/Users/Alunos/Documents/GitHub/templatezero/backend/sqlite/test_drive.db";
            $filepath =  "C:/Users/Alunos/Documents/GitHub/templatezero/backend/sqlite/test_drive.db";
